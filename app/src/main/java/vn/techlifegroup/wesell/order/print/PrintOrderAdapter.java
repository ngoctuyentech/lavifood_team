package vn.techlifegroup.wesell.order.print;
...
public class PrintOrderAdapter extends PrintDocumentAdapter {
    ...
    public PrintOrderAdapter(ImageAndTextContainer container, Context cxt) {
