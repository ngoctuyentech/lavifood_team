...
public class Constants {
    ...
    public static DatabaseReference refLogin = FirebaseDatabase.getInstance().getReference().child("1-System/Login");
    public static DatabaseReference refRole= FirebaseDatabase.getInstance().getReference().child("1-System/Role");
